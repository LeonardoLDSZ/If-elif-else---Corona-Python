...
while opcao != 11:
    ...
    if opcao == 1 or opcao == 2 or opcao == 3 or opcao == 4 or opcao == 5 or opcao == 6 or opcao == 7 or opcao == 8 or opcao == 9:
        print(
            f'{nome} {sobrenome}, {idade} anos de idade, não possui todos os sintomas do Corona Virús, contudo, deverá ficar em isolamento como precaução.')
        break
    elif opcao == 10:
        print(
            f'{nome} {sobrenome}, {idade} anos de idade, possui os sintomas do Corona Vírus e deverá se dirigir IMEDIATAMENTE ao posto de saúde mais próximo!')
        break
    elif opcao == 11:
